...
class DiffusionSampler:
    ...
    #         if self.model.cond_enc is not None and ((not hasattr(self.model, 'style_enc')) or self.model.style_enc is None):
    #             c = self.model.cond_enc(c)
    ...
    #             c = self.model.cond_enc(c)
    #             return self.model(x, t, c)
    #         elif self.model.cond_enc is None:
    #             return self.model(x, t, uncond_cond)
    #         elif self.model.style_enc is not None:
    #             # print('Using style encoder!')
    #             c1, c2 = c
    #             c1 = self.model.cond_enc(c1)
    #             c2 = self.model.style_enc(c2)
    #             c = torch.cat([c1, c2], 1)
    #
    #             r1 = self.model(x, t, c)
    #             c2[:] = -1
